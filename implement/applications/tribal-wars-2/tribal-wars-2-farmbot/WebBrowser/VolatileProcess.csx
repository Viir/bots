...
//  https://www.nuget.org/api/v2/package/PuppeteerSharp/7.1.0
#r "sha256:3e505ac9f224cc52da9c4d3dcc89d507d120203708c3fdf036cf5079ee346027"

//  https://www.nuget.org/api/v2/package/Microsoft.Bcl.AsyncInterfaces/6.0.0
#r "sha256:5705D245072D3EB78400547B32147DBB6E2C8B02BA8BDA76729798F5EFDEAECB"
...
bool ProcessIsWebBrowser(System.Diagnostics.Process process)
{
    ...
    {
        return
            MapFilePathForEqualityComparison(process.MainModule.FileName)
            .Contains(MapFilePathForEqualityComparison(BrowserDownloadDirPath()));
    }
    catch
    {
        return false;
...
static string MapFilePathForEqualityComparison(string filePath) =>
