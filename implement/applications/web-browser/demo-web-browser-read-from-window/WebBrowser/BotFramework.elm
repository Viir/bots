...
type BotEvent
    ...
    | ReadFromWindowResponse (Result String InterfaceToHost.ReadFromWindowCompleteStruct)
...
type BotRequest
    ...
    | SetZoomFactorRequest { zoomFactorMikro : Int }
    | StartWebBrowserRequest StartWebBrowserRequestStruct
    | ReadFromWebBrowserWindowRequest
    ...
    let
        ...
        ( stateUpdatedForBotRequest, tasksFromBotRequest ) =
            case botRequest of
                ...
                SetZoomFactorRequest setZoomFactor ->
                    case stateBefore.webBrowser of
                        Just (RunningWebBrowserState runningWebBrowser) ->
                            ( stateBefore
                            , [ ( Just "set-zoom-factor"
                                , InterfaceToHost.InvokeMethodOnWindowRequest
                                    runningWebBrowser.openWindowResult.windowId
                                    (InterfaceToHost.SetZoomFactorOnWebViewMethod setZoomFactor)
                                )
                              ]
                            )
            ...
            case invokeMethodOnWindowResponse of
                ...
                Ok invokeMethodOnWindowOk ->
                    case invokeMethodOnWindowOk of
                        ...
                        InterfaceToHost.ReadFromWindowMethodResult readFromWindowOk ->
                            ( webBrowserStateBefore
                            , Just
                                (OperationTask (ReadFromWindowResponse (Ok readFromWindowOk)))
                            )
