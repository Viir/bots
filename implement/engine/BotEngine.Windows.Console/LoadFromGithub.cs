...
namespace BotEngine.Windows.Console
{
    ...
    {
        /// <summary>
        /// Sample address to a tree as found in the guide from https://github.com/Viir/bots/blob/32559530694cc0523f77b7ea27c530ecaecd7d2f/guide/how-to-use-eve-online-bots.md:
        /// https://github.com/Viir/bots/tree/de00799cd5edf771f210c8265d249f1380bd6382/implement/bot/eve-online/eve-online-warp-to-0-autopilot
        /// 
        ...
        static public LoadFromUrlResult LoadFromUrl(string sourceUrl)
        {
            ...
            LiteralNodeObject literalNodeObject = null;
        ...
        public class LoadFromUrlResult
        {
            ...
            public LiteralNodeObject Success;

            public byte[] AsBlob => Success?.BlobContent;
        }
